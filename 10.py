...
botStart = time.time()
#==============================================================================#
line = LINE("EDqRVUcShkwZwPdpqv37.MNDJ+FLNS0xznCFGA2mQ1W.ImVOCE3qtyYJL9XfvKsiNqy+/ggJzGaDkTBll7Dztx0")
line.log("Auth Token : " + str(line.authToken))
# Assist
ki = LINE("EDkRobZOqw8xtawF38M4.+0VwFLVgQ2j2cX+3JyNF5a.wKILaaflA5oamztZbovmR+6jR6vOYD8o1PL8anw7DPU")
ki.log("Auth Token : " + str(ki.authToken))
kk = LINE("EDmmACtaZtftDRgpOGF6.xBAEeq5CEKAfHgmSzhk7zG.O+g8s5mIpajoehQgENDP23F+ADenR/ewnTTMZFenG0o")
kk.log("Auth Token : " + str(kk.authToken))
kc = LINE("EDySmu8JaixmTTqPDxXa.F/033Vty47ZVwBhORXhAoG.1L9VB5uGqd9GCbEGTlt8cLGHU0Hphp7YCH4jJnUJj+0")
kc.log("Auth Token : " + str(kc.authToken))
ke = LINE("EDdLG5F0OavaJVcZPSm2.iFiwAtxjMF5fdoxQwQqMuG.Z6nAqFFI35JjW/t0CbULHCVIPA4d+0gM3ky0WmNaaQY")
ke.log("Auth Token : " + str(ke.authToken))
ks = LINE("EDG9ddwi4UJJE9eKTjz5.jZLwNsJF0dLY/sVeui1BLq.2ZJBuS4L/VS+0ICtUrpQ6yLj+nsGY8tgx1etlIpHNfE")
ks.log("Auth Token : " + str(ks.authToken))
kt = LINE("EDy6GjCjwZtxmW8xhhU0.4joXktOiD5sMDqP3TEW5Ka.s9hzIugfKlyEgv0+08AwgavfJPgwda5Ay/DSfofg7ys")
kt.log("Auth Token : " + str(kt.authToken))
k1 = LINE("ED0sIIHi4tNVA9M9m4wa.z1BLPUXch76fSXC9ldkHAG.mM6taYjl4kQ2jZHbAP79c6kCXI0+buRgSxHI/xreS+A")
k1.log("Auth Token : " + str(k1.authToken)) 
k2 = LINE("EDD6brpB5cwBSu9Omdk6.P0DywLibVMEvA1w8+MyKzG.brQqV8kViu+ZO+8eJMDVe6jZICDBFmoID/CrZQvPqfg")
k2.log("Auth Token : " + str(k2.authToken))
k3 = LINE("EDzq34Cvd3YaL9yFxkzb.jsVVBl6s1wGGAmAWEJzz2W.QNoePXFmXOj5Z0Bfhhqyy2EhfqSpmztmFNkyvHpfPII")
k3.log("Auth Token : " + str(k3.authToken))
g1 = LINE("EDOjQ4prBWdnsJzdhdb2.LXYsXPKv919TqN1yc47NOG.oB9HAse68CKY3CbwGv+F4pKbRvnFD+v7+8EklZ7Svwo")
g1.log("Auth Token : " + str(g1.authToken))
g2 = LINE("EDGS0yz22jcchjXBx6f8.r4o5B2rVFUt3ErkQ8VWwYa.4zBZ5Q6I9yawwrEVHon2KQy+Kghr0WjX2BbEAqO+AC0")
